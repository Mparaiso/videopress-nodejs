...
"use strict";
var Playlist, Video, async, controllers, database, express, forms, players, _;
...
controllers.playlistUpdate = function(req, res) {
  return res.send(200, 'todo implement');
};

controllers.playlistRemove = function(req, res) {
  return res.send(200, 'todo', 'implement');
};
